...
export const BottomNav: React.FC<BottomNavProps> = ({ currentView, setCurrentView }) => {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-white/90 border-t border-slate-200 px-4 py-2 flex justify-around items-center shadow-[0_-5px_20px_rgba(0,0,0,0.05)]">
            {items.map((item) => {
