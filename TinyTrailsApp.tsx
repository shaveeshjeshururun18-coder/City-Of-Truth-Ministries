        ...
        >
          ...
          <div className="pt-4 border-t border-white/10 mt-auto">
            <a
              href="/"
              onClick={() => setIsMenuOpen(false)}
              className="w-full py-4 rounded-full bg-white font-semibold text-base text-[#F16524] hover:scale-[1.02] active:scale-95 transition-transform flex items-center justify-center gap-2 shadow-lg cursor-pointer border-none outline-none no-underline"
            >
