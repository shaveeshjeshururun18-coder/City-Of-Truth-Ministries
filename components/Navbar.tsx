...
import { Menu, X, Church, Home, Info, Heart, Flame, Phone, ChevronRight, CreditCard, Facebook, Youtube, Instagram, MapPin, Languages, Zap, Sparkles, Send, Globe, LogIn, CircleUser, LogOut } from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  { label: 'ALPHABET', view: ViewState.HEBREW },
  { label: 'RESOURCES', view: ViewState.ABOUT },
